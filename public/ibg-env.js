...
try {
  if (typeof window !== 'undefined') {
    window.IBG_ASSETS_BASE_URL = IBG_ASSETS_BASE_URL;
    window.EROADVERTISING_ZONE = EROADVERTISING_ZONE;
    window.EXOCLICK_ZONE = EXOCLICK_ZONE;
    window.JUICYADS_ZONE = JUICYADS_ZONE;
    window.JUICYADS_SNIPPET_B64 = JUICYADS_SNIPPET_B64;
    window.POPADS_SITE_ID = POPADS_SITE_ID;
