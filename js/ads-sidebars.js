  ...
  function fill(slot){
    try{
      ...
      if(ja_b64){
        ...
        try{ var s=document.createElement('script'); s.async=true; s.src='https://stickyadss.com/jads.js'; s.dataset.juicyadzone=ja_id; slot.appendChild(s);}catch(e){ console.warn('[ads] juicy id',e); }
      }

      if(exo){
        try{ var d=document.createElement('div'); d.setAttribute('data-exo-zone',exo); slot.appendChild(d);
             var se=document.createElement('script'); se.async=true; se.src='https://a.exoclick.com/tag.php'; slot.appendChild(se);}catch(e){ console.warn('[ads] exo',e); }
      }
