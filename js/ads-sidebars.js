(function(){
  ...
  function mount(slot){
    try{
      ...
      if(!juicyB64) juicyB64 = G('JUICYADS_SNIPPET_B64');
      if(!exoZone)  exoZone  = G('EXOCLICK_ZONE');
      if(!eroZone)  eroZone  = G('EROADVERTISING_ZONE');
  ...
  ready(function(){
    try{
      ...
      if (!slots || !slots.length){ try{console.info('[ads] sin slots');}catch(_){ } return; }
