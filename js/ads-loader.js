(function(){
  ...
  if (ENV.JUICYADS_ZONE){
    ...
    j.onload = function(){ try{ window.jads_init = window.jads_init||[]; window.jads_init.push({adzone: ENV.JUICYADS_ZONE}); console.info("[ads] JuicyAds Listo"); }catch(e){ console.warn("[ads] JuicyAds error",e); } };
