(function(){
  ...
  function ready(){
    try { document.dispatchEvent(new CustomEvent('paypal:sdk:ready', { detail: { intent: intent } })); } catch(_){}
  }
  ...
  qs += (intent === 'subscription') ? '&intent=subscription&vault=true' : '&intent=capture';
